        ...
        <div className="space-y-2.5">
          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            <span className="flex items-center gap-1.5 text-base-content/80">
              <span className="tooltip tooltip-right" data-tip={r.country_source || r.country || ''}>
      ...
      >
        ...
        <td className="py-3">
          <div className="flex items-center gap-2">
            ...
            <span className="tooltip tooltip-bottom hidden sm:inline-flex items-center gap-0.5"
              data-tip={result.resolver.country_source || result.resolver.country || ''}>
